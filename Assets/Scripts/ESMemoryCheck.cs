...
public class ESMemoryCheck : MonoBehaviour
{
    ...
    public ESCartesAffichage affiche;
    ...
    public void suppr2pairespart1()
    {
        ...
        restartsuppr1:
            ...
            foreach (ESCartesAffichage c in cul)
            {
