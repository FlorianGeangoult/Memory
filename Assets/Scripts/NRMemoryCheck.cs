...
public class NRMemoryCheck : MonoBehaviour
{
    ...
    public NRCartesAffichage affiche;
    ...
    public void suppr2pairespart1()
    {
        ...
        restartsuppr1:
            ...
            foreach (NRCartesAffichage c in cul)
            {
